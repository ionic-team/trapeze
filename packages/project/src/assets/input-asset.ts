...
import type { AssetKind, Platform } from './asset-types';
import { Format } from './asset-types';
...
export class InputAsset {
  ...
  async generate(strategy: AssetGenerator, project: MobileProject): Promise<OutputAsset[]> {
