...
export class AndroidAssetGenerator extends AssetGenerator {
  ...
  private async generateAdaptiveIconForeground(asset: InputAsset, project: MobileProject): Promise<OutputAsset[]> {
    const icons = Object.values(AndroidAssetTemplates).filter(
      (a) => a.kind === AssetKind.Icon,
    ) as AndroidOutputAssetTemplateAdaptiveIcon[];
...
<adaptive-icon xmlns:android="http://schemas.android.com/apk/res/android">
  ...
  private async generateAdaptiveIconBackground(asset: InputAsset, project: MobileProject): Promise<OutputAsset[]> {
    const icons = Object.values(AndroidAssetTemplates).filter(
      (a) => a.kind === AssetKind.Icon,
    ) as AndroidOutputAssetTemplateAdaptiveIcon[];
...
<adaptive-icon xmlns:android="http://schemas.android.com/apk/res/android">
  ...
  private async updateManifest(project: MobileProject) {
