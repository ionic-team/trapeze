// Generated from /Users/max/git/trapeze/packages/parser/kotlin/KotlinParser.g4 by ANTLR 4.9.2
...
public class KotlinParser extends Parser {
	...
	public static final int
		...
		RULE_enumEntries = 47, RULE_enumEntry = 48, RULE_rustType = 49, RULE_typeReference = 50, 
	...
	public static class TypeAliasContext extends ParserRuleContext {
		...
		public RustTypeContext rustType() {
			return getRuleContext(RustTypeContext.class,0);
		}
	...
	public static class RustTypeContext extends ParserRuleContext {
		...
		public RustTypeContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_rustType; }
	}

	public final RustTypeContext rustType() throws RecognitionException {
		RustTypeContext _localctx = new RustTypeContext(_ctx, getState());
		enterRule(_localctx, 98, RULE_rustType);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1679);
	...
	public static class FunctionTypeParametersContext extends ParserRuleContext {
		...
		public List<RustTypeContext> rustType() {
			return getRuleContexts(RustTypeContext.class);
		}
		public RustTypeContext rustType(int i) {
			return getRuleContext(RustTypeContext.class,i);
		}
		public List<TerminalNode> COMMA() { return getTokens(KotlinParser.COMMA); }
		public TerminalNode COMMA(int i) {
			return getToken(KotlinParser.COMMA, i);
