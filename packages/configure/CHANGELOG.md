...
* **configure:** honor dry-run for copy/res, fix xml attrs wiring, register --projectRoot ([#254](https://github.com/ionic-team/trapeze/issues/254)) ([adb48ad](https://github.com/ionic-team/trapeze/commit/adb48ad22cbbfa545d5a9cc20690356aad9b7121))
* **configure:** stop dropping keys next to targets/builds and interpolate map keys ([#245](https://github.com/ionic-team/trapeze/issues/245)) ([1fe1da5](https://github.com/ionic-team/trapeze/commit/1fe1da5e1b13f135076422a819520610a7247915))
...
* The following workspace dependencies were updated
  * dependencies
    * @trapezedev/project bumped from ^7.1.8 to ^7.1.9
